...
<body>
<h1 class="text-center text-uppercase display-4 font-weight-bold" style="background-color: #74B3CE; color: white; font-family: 'Cormorant Unicase', serif;"> Here <span style="color:red">Order </span> To Admin</h1>
<div class="container">

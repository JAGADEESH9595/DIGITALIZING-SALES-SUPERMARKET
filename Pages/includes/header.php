...
<title>Digitalizing Sells Super market Management System</title>
<!-- // Stylesheets // -->
...
<div id="wrapper_sec">
	<div id="masthead">
    	<div class="logo">
        	<a href="./index.php" class="logo-custom">J A N U Digitalizing Sales Supermarket</a>
        </div>
		<?php if($_SESSION['login']) { ?> 
       <br> <div class="slogan" style="color:#ffffff; font-weight:bold; font-size:14px;">Welcome <?=$_SESSION['user_details']['user_name']?></div>
		<?php } else { ?>
		<div class="slogan"></div>
		<?php } ?>
        <div class="clear"></div>
            <div class="navigation">
            	<div id="smoothmenu1" class="ddsmoothmenu"  style="background-color:green;">
                    <ul>
